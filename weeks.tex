...
/home/capucine/graalvm/labsjdk-ce-21/src/java.base/share/classes/java/lang/invoke/MethodHandleImpl.java:236:             // TODO skip if arrayClass.getComponentType().isPrimitive;
...
ThreadLocal that might be replaced with a LambdaCalls:
- MethodHandlesLookup#linkMethodHandleConstant
...
Allow load resource bundle: 
sun.util.resources.Bundles#loadBundleFromProviders
java.util.MissingReflectionRegistrationError: The program tried to reflectively access class sun.text.resources.cldr.ext.FormatData_pa without it being registered for runtime reflection. Add sun.text.resources.cldr.ext.FormatData_pa to the reflection metadata to solve this problem. See https://www.graalvm.org/latest/reference-manual/native-image/metadata/#reflection for help.
        at java.base/jdk.internal.restrict.reflect.MissingReflectionRegistrationUtils.forClass(MissingReflectionRegistrationUtils.java:9)
        at java.base/jdk.internal.restrict.LanguageRestriction.isClassPreloaded(LanguageRestriction.java:138)
        at java.base/jdk.internal.restrict.LanguageRestrictionManager.dynamicClassLoadingCheck(LanguageRestrictionManager.java:133)
        at java.base/java.lang.ClassLoader.findLoadedClass0(Native Method)
        at java.base/java.lang.ClassLoader.findLoadedClass(ClassLoader.java:1326)
        at java.base/java.lang.ClassLoader.loadClass(ClassLoader.java:662)
        at java.base/java.lang.Class.forName(Class.java:629)
        at java.base/java.lang.Class.forName(Class.java:604)
...
TODO TODO TODOTODOTODOTODOTODOTODOTODOTODOTODOTODOTODOTODOTODOTODOTODOTODOTODOTODOTODOTODOTODO
