...
We modify all reﬂective Java features to operate under the closed-world assumption by checking the reachability metadata to determine if the reﬂectively-accessed element is included in the image. We introduce a new Tracing Agent to collect the metadata. 
