...
% TODO why did we implement a new agent in Java?
...
% This could be in part due to the way the native restrictions scopes are implemented. 

% suspect that the restrictions check for objectOffsetField (for VarHandles and virutal thread) does not play nicely with concurrency -> deadlock for 2 test that tests for deadlocks:
% # -javasoft_sqe_tests_api_java_lang_management_ThreadMXBean_FindDeadLockedSynchronizers
% # -javasoft_sqe_tests_api_java_lang_management_ThreadMXBean_FindDeadLockedSynchronizers
% 
% api/javax_management/create_delete/ValidMgtIf0001.html
% api/javax_management/create_delete/ValidMgtIf0002.html
% 
% # - api/java_applet/Applet/Ctor.html
% # - api/java_applet/AudioClip/AudioClip.html
% # - api/java_awt/AWTError/serial/Input.html
% # - api/java_awt/AWTKeyStroke/CCC_4370733.html
