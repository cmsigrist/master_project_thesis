...
Under this assumption, all the application's classes must be known at \emph{build time} to be included into the image. \todo{feels like it's missing a sentence...}
